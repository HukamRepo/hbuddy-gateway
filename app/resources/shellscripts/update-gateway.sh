...
#
# Provides: gateway
# Short-Description: Start/Stop Hukam hBuddy Gateway
# chkconfig: 234 20 80
#
#
# Copyright (C) 2016 Hukam
#
...
# sudo -i
 echo "<<<< INSIDE HUKAM HBUDDY GATEWAY STARTUP SCRIPT  >>>>>"
...
if [ ! -d "hbuddy-gateway" ]; then
	echo "<<<< GOING TO CREATE HUKAM HBUDDY APPLICATION >>>>>"
	sudo git clone https://github.com/sinny777/hbuddy-gateway.git
	cd hbuddy-gateway
else
	echo "<<<< GOING TO UPDATE HUKAM APPLICATION >>>>>"
	cd hbuddy-gateway
	sudo git fetch --all
